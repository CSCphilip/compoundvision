...
export default function CompoundVisionV3() {
  ...
  return (
    <main className="flex flex-col bg-[#0d1421] w-screen min-h-screen overflow-x-hidden">
      ...
      {/* <div className="hidden z-0 w-11/12 max-w-[370px] sm:max-w-full h-5/6 self-center absolute mt-28 sm:mt-32 border-t-2 border-x-2 border-blue-700 rounded-full border-shadow" /> */}
      <div className="hidden lg:inline z-0 w-11/12 h-5/6 self-center absolute mt-32 border-t-2 border-x-2 border-blue-700 rounded-full border-shadow" />
