...
export default function CompoundVisionV3() {
  ...
  return (
    <main className="flex flex-col bg-[#0d1421] w-screen min-h-screen overflow-x-hidden">
      ...
      <div className="hidden sm:inline z-0 w-11/12 h-5/6 self-center absolute mt-32 border-t-2 border-x-2 border-blue-700 rounded-full border-shadow" />

      <div className="relative left-1/2 transform -translate-x-1/2 w-fit h-fit mt-10 sm:mt-20">
        {/* Chart and FV: */}
